...
function SiderComponent ({ collapsed, toggle }) {
  ...
  const { role, permissions } = getter(["permissions", "role"])
  ...
  function MyMenu({ role, permissions }) {
    ...
    return (
      <Menu karet-lift theme="light" mode="inline"openKeys={openKeys} selectedKeys={selectedKeys} onClick={menuItemClick} multiple={false}>
