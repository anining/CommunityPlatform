...
import { Button, Popconfirm, DatePicker, Menu, Dropdown, Table, message, Input, Space, Modal } from 'antd'
  ...
  return (
    <div style={styles.main}>
      <div style={{
        ...
        <div>
          <Input placeholder="请输入订单编号" size="small" style={{width:120,fontSize:12,marginRight:20}}/>
          <Input placeholder="请输入商品名称" size="small" style={{width:120,fontSize:12,marginRight:20}}/>
          <Input placeholder="请输入预留方式" size="small" style={{width:120,fontSize:12}}/>
        ...
        <div>
          ...
          type = "primary"
          size = "small"
            style = { { fontSize: 12,height:20 } } > 搜索订单 < /Button>
        </div>
      </div>
      <div style={{
        display:'flex',
        ...
        <Dropdown overlay={menu} style={styles.dropdown}>
          <Button style={{...styles.dropdown,...{marginLeft:0}}} size="small">
            请选择供货商 <DownOutlined />
          </Button>
        </Dropdown>
        <DatePicker.RangePicker style={{height:20,marginLeft:20}} />
        <div>
        </div>
      </div>
      <div style={{
